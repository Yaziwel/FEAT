...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="./configs/cho/cho_sample_with_rwkv")
    parser.add_argument("--ckpt", type=str, default="./results_models/017-EnDoraIMG-XL-2-with-rwkv-F16S3-cho_img/checkpoints/0010000.pt")
